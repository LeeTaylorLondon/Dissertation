...
from data_prep.sentences import list_info, load_pickle_file, store_pickle_file
import numpy as np
import gensim
import gzip
import shutil
...
def expand_set(model_fp='google_w2v_weights/GoogleNews-'
    ...
    :param output_fn: str - file name of the set_expansion to be stored and written to
...
if __name__ == '__main__':
    ...
    """
    expand_set(model_fp='model_weights/mit_wiki_model.model',
